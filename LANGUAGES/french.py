...
STR_PLAYER_TOURNAMENT_1 = "Voici les ID de joueurs présents lors du Tournoi N°"
STR_PLAYER_TOURNAMENT_rank = "avec le classement "
...
ADD_PLAYERS_FOR_TOURNAMENT = "Choix 2 : Ajouter les huits joueurs pour le tournoi"
MODIFY_PLAYERS_FOR_TOURNAMENT = "Choix 2 : Modifier la liste des ID de joueurs pour le tournoi"

LAST_TOURNAMENT = "Le tournoi en cours est : "
LAST_TOURNAMENT_NONE = "Il n'y a aucun tournoi de créer dans la base à ce jour."
...
INFORM_INPUT_PLAYERS = "Merci de saisir les ID des 8 joueurs pour le tournoi : "
ERROR_INPUT_PLAYER = " Merci de saisir un ID de joueur valide svp !"
LISTING_PLAYERS_TO_CONFIRM = "Voici la liste des joueurs que vous avez sélectionné :"
CHOICE_TIME = ["Bullet", "Blitz", "Coup rapide"]
SELECT_CONTROL_TIME = "Voici la liste des contrôleur du temps disponibles : "
INPUT_DESCRIPTION_TOURNAMENT = "Vous pouvez saisir une description de tournoi : "
...
ERROR_PLAYER_ALREADY_IN_TOURNAMENT = "Attention cet ID de joueur a déjà été saisie dans la liste liée au tournoi"
# MENU_ADD_PLAYER
...
ERROR_MIN_PLAYERS_IN_DATABASE = "ATTENTION, la base de données ne contient pas le minimum de joueurs requis" \
                                " \npour la création d'un tournoi, merci de rajouter des joueurs en BDD."
...
WITH_PLAYER = "pour le joueur"
CHOICE_SCORE = "Le joueur a gagné (Choix 1), est à égalité (Choix 2) ou a perdu (Choix 3) ?"
